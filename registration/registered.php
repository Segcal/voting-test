...
$query1 ="INSERT into user(username,password,name,email,phone,image1,slice1,image2,slice2,image3,slice3,userimage) 
values('$name','$password','$realname','$email',$phone,'$image1','$slice1','$image2','$slice2','$image3','$slice3','../user/images/user/default.png')";

$query2 =  "INSERT INTO voters (voters_id, password, firstname, lastname, photo) VALUES ('$voter', '$hash', '$firstname', '$lastname', '../user/images/user/default.png')";
